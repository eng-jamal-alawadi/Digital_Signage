      ...
      <form id="create-form" action="{{route('floors.update',$floor->id) }} " method="POST" >
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="raspberry_pi_ip_address" value="{{$floor->raspberry_pi_ip_address}}" placeholder="Enter Raspberry pi ip address" >
          </div>
          ...
          <div class="form-group  mt-3">
            ...
            <select class="form-control" name="building_id" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
